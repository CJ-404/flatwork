...
import 'package:flatwork/screens/edit_passward.dart';
...
final appRoutes = [
  ...
  GoRoute(
    path: RouteLocation.editPassword,
    name: RouteLocation.editPassword,
    parentNavigatorKey:navigationKey,
    builder: EditPassword.builder,
  ),
  GoRoute(
  ...
  GoRoute(
    ...
    builder: (context, state) => InboxScreen.builder(
        ...
        state.pathParameters['receiverName'] as String,
        state.pathParameters['receiverId'] as String,
